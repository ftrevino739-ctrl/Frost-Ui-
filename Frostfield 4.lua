...
local Theme = {
	...
	Element = Color3.fromRGB(98, 130, 172),
...
local function drawGear(parent)
	...
	hole.BackgroundColor3 = Color3.fromRGB(58, 86, 122)
...
local function makeElement(parent)
	...
	f.BackgroundTransparency = 0.46
	f.BorderSizePixel = 0
	f.Text = ""
	f.Parent = parent
	round(f, 14)
	local st = stroke(f, Color3.fromRGB(210, 230, 250), 1, 0.55)
	track(f.MouseEnter:Connect(function()
		tween(f, 0.12, { BackgroundTransparency = 0.32 })
		st.Transparency = 0.35
	end))
	track(f.MouseLeave:Connect(function()
		tween(f, 0.12, { BackgroundTransparency = 0.46 })
...
local function buildChrome(opts)
	...
	sidebar.BackgroundColor3 = Color3.fromRGB(58, 86, 122)
