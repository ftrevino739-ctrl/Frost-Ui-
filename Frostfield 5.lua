...
local function drawDiscord(parent)
	...
	earL.Name = "Body"
	earL.Size = UDim2.fromOffset(4, 6)
	earL.Position = UDim2.fromOffset(2, 1)
	earL.Rotation = -18
	earL.BackgroundColor3 = color
	earL.BorderSizePixel = 0
	earL.Parent = holder
	round(earL, 1)
	local earR = Instance.new("Frame")
	earR.Name = "Body"
	earR.Size = UDim2.fromOffset(4, 6)
	earR.Position = UDim2.fromOffset(12, 1)
	earR.Rotation = 18
	earR.BackgroundColor3 = color
	earR.BorderSizePixel = 0
	earR.Parent = holder
	round(earR, 1)
	local body = Instance.new("Frame")
	body.Name = "Body"
	body.Size = UDim2.fromOffset(16, 11)
	body.Position = UDim2.fromOffset(1, 4)
	...
	eyeL.Name = "Hole"
	eyeL.Size = UDim2.fromOffset(3, 4)
	eyeL.Position = UDim2.fromOffset(4, 7)
	eyeL.BackgroundColor3 = Color3.fromRGB(40, 60, 95)
	...
	eyeR.Name = "Hole"
	eyeR.Size = UDim2.fromOffset(3, 4)
	eyeR.Position = UDim2.fromOffset(11, 7)
	eyeR.BackgroundColor3 = Color3.fromRGB(40, 60, 95)
...
local function buildChrome(opts)
	...
	window.Parent = gui
	round(window, 12)
	stroke(window, Color3.fromRGB(190, 220, 250), 1, 0.45)
	State.window = window
